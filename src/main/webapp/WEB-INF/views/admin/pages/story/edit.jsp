...
<h1 class="text-uppercase py-3">chỉnh sửa "${story.storyName }"</h1>
...
<f:form action="" method="post" modelAttribute="story"
	...
	<div class="form-group">
		...
		<f:input path="storyId"
			...
			placeholder="Nhập mã truyện..." readonly="true" />
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<img id="blah" src="${pageContext.servletContext.contextPath}/${story.image}"
	...
	<button type="submit" class="btn btn-primary rounded-0">Cập nhật</button>
</f:form>
